...
import static s1riys.lab7.common.constants.Network.*;
...
//        try {
//            System.out.println("Before connet");
//            connectToClient(address);
//            System.out.println("After connet");
//
//            logger.info("Соединено с {}", address);
//            System.out.println("Соеденились с клиентом");
//        } catch (Exception e) {
//            System.out.println("XXX Соеденились с клиентом");
