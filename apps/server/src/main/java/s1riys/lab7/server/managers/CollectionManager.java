...
public class CollectionManager {
    ...
    public int remove(long id, User user) throws ForbiddenException {
        ...
        if (productToDelete.getCreator().getId() != user.getId()) throw new ForbiddenException();
    ...
    public void update(Long id, Product product, User user) throws ForbiddenException {
        ...
        if (productToUpdate.getCreator().getId() != user.getId()) throw new ForbiddenException();
        else {
     ...
     */
    public void clear() {
        // TODO: add clear method to truncate DB
        updateSaveTime();
        collection.clear();
    }
}
